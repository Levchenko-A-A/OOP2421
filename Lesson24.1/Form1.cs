namespace Lesson24._1
{
    public partial class Form1 : Form
    {
        ...
        {
            users.Add(new User(textBoxFirstName.Text, textBoxFirstName.Text, int.Parse(textBoxAge.Text)));
            UpdateForm();
        }
        private void UpdateForm()
        {
            ...
            {
                dataGridViewUsers.Columns[i].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
            }
            textBoxLastName.Text = textBoxFirstName.Text = textBoxAge.Text = string.Empty;
            buttonEdit.Visible = false;
        }
